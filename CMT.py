...
class Block(nn.Module):
    ...
    def forward(self, x, H, W, relative_pos):
        ...
        x = self.proj(cnn_feat) + cnn_feat #LPU的架构
        x = x.flatten(2).permute(0, 2, 1)  #展成了TS要用的格式
...
class CMT(nn.Module):
    def __init__(self, img_size=256, in_chans=3, num_classes=1000, embed_dims=[46,92,184,368], stem_channel=16, fc_dim=1280,
